 ...
 *
 * Ejecutar desde la carpeta /backend (donde ya está sharp instalado):
 *   cd backend
...
async function convert(filePath) {
  ...
  // No sobreescribir si el .webp ya existe y es reciente
  try {
...
async function main() {
  ...
  console.log('\nPróximo paso: reemplaza las rutas .png/.jpg por .webp en los componentes Vue.')
}
